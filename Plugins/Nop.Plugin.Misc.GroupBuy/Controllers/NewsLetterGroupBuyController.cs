...
{
    public class NewsLetterGroupBuyController : BasePublicController
    {
        #region fields
        ...
        public ActionResult NewsletterGroupBuyBox()
        {
            ...
            return PartialView("~/Plugins/Misc.GroupBuy/Views/NewsLetter/NewsletterGroupBuyBox.cshtml", model);
        }
        ...
        public ActionResult SubscriptionActivation(Guid token, bool active)
        {
            ...
            return View("~/Plugins/Misc.GroupBuy/Views/NewsLetter/SubscriptionActivation.cshtml", model);
        }
        ...
        public ActionResult List()
        {
            ...
            return View("~/Plugins/Misc.GroupBuy/Views/NewsLetter/Admin/List.cshtml", model);
        }
