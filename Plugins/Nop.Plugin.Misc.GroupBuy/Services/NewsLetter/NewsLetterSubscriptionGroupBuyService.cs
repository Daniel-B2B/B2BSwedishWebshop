...
{
    public class NewsLetterSubscriptionGroupBuyService : INewsLetterSubscriptionGroupBuyService
    {
        #region Fields

        private readonly IEventPublisher _eventPublisher;
        private readonly IDbContext _context;
        private readonly IRepository<NewsLetterSubscriptionGroupBuy> _subscriptionRepository;
        ...
        public NewsLetterSubscriptionGroupBuyService(IDbContext context,
            IRepository<NewsLetterSubscriptionGroupBuy> subscriptionRepository,
        ...
        private void PublishSubscriptionEvent(NewsLetterSubscriptionGroupBuy subscription, bool isSubscribe, bool publishSubscriptionEvents)
        {
            if (publishSubscriptionEvents)
            {
                NewsLetterSubscription subscriptionModel = new NewsLetterSubscription();
                subscriptionModel.Email = subscription.Email;
                subscriptionModel.Active = subscription.Active;
                subscriptionModel.CreatedOnUtc = subscription.CreatedOnUtc;
                subscriptionModel.Id = subscription.Id;
                subscriptionModel.StoreId = subscription.StoreId;
                subscriptionModel.NewsLetterSubscriptionGuid = subscription.NewsLetterSubscriptionGuid;
                if (isSubscribe)
                {
                    _eventPublisher.PublishNewsletterSubscribe(subscriptionModel);
                }
                else
                {
                    _eventPublisher.PublishNewsletterUnsubscribe(subscriptionModel);
                }
            }
        }
        #endregion
        ...
        /// <param name="publishSubscriptionEvents">if set to <c>true</c> [publish subscription events].</param>
        public virtual void InsertNewsLetterSubscriptionGroupBuy(NewsLetterSubscriptionGroupBuy newsLetterSubscription, bool publishSubscriptionEvents = true)
        {
        ...
        /// <param name="newsLetterSubscription">NewsLetter subscription</param>
        /// <param name="publishSubscriptionEvents">if set to <c>true</c> [publish subscription events].</param>
        public virtual void UpdateNewsLetterSubscriptionGroupBuy(NewsLetterSubscriptionGroupBuy newsLetterSubscription, bool publishSubscriptionEvents = true)
        {
            if (newsLetterSubscription == null)
            {
                throw new ArgumentNullException("newsLetterSubscription");
            ...
            var originalSubscription = GetNewsLetterSubscriptionGroupBuyByGuid(newsLetterSubscription.NewsLetterSubscriptionGuid);
        ...
        /// <param name="newsLetterSubscription">NewsLetter subscription</param>
        /// <param name="publishSubscriptionEvents">if set to <c>true</c> [publish subscription events].</param>
        public virtual void DeleteNewsLetterSubscriptionGroupBuy(NewsLetterSubscriptionGroupBuy newsLetterSubscription, bool publishSubscriptionEvents = true)
        {
        ...
        public virtual NewsLetterSubscriptionGroupBuy GetNewsLetterSubscriptionGroupBuyById(int newsLetterSubscriptionId)
        {
        ...
        /// <returns>NewsLetter subscription</returns>
        public virtual NewsLetterSubscriptionGroupBuy GetNewsLetterSubscriptionGroupBuyByGuid(Guid newsLetterSubscriptionGuid)
        {
        ...
        /// <returns>NewsLetter subscription</returns>
        public virtual NewsLetterSubscriptionGroupBuy GetNewsLetterSubscriptionGroupBuyByEmailAndStoreId(string email, int storeId)
        {
        ...
        public virtual IPagedList<NewsLetterSubscriptionGroupBuy> GetAllNewsLetterSubscriptionsGroupBuy(string email = null,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            if (customerRoleId == 0)
            {
                ...
                var subscriptions = new PagedList<NewsLetterSubscriptionGroupBuy>(query, pageIndex, pageSize);
            ...
            else
            {
                ...
                else
                {
                    ...
                    var subscriptions = new PagedList<NewsLetterSubscriptionGroupBuy>(query.Select(x => x.NewsletterSubscribers), pageIndex, pageSize);
                    return subscriptions;
                }
            }
        }
