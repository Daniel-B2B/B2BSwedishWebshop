...
namespace Nop.Plugin.Payments.Beanstream
{
    ...
    public class BeanstreamPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            Console.WriteLine(postProcessPaymentRequest);


            ////common

            ////pass order
            var orderTotal = Math.Round(postProcessPaymentRequest.Order.OrderTotal, 2).ToString();
            ...
            string accessToken = "QluWWK4osSdLaSIQtY6w";
            string merchantNumber = "P349849702";
            string secretToken = "qRgB3tecwYMC5pIWE1jx1kOsCj47Qcg8UtiYeI3C";
            ...
            StringBuilder orderTotalConverted = new StringBuilder(orderTotal);
            orderTotalConverted.Replace(",", string.Empty);
            orderTotalConverted.Replace(".", string.Empty);
            ...
            dynamic checkoutRequest = new
            {
                order = new
                {
                    id = postProcessPaymentRequest.Order.Id,
                    amount = orderTotal.Replace(",", string.Empty),
                    currency = postProcessPaymentRequest.Order.CustomerCurrencyCode
                },
                url = new
                {
                    accept = "https://b2bpromotion.dk/PaymentBeanstream/ResponseNotificationHandler",
                    cancel = "https://b2bpromotion.dk/",
                    //accept = "http://localhost:15537/PaymentBeanstream/ResponseNotificationHandler",
                    //cancel = "http://localhost:15537",
            ...
            _httpContext.Response.Redirect(checkoutResponse.url.ToString());
        }
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Beanstream.Fields.RedirectionTip", "Betal med kreditkort.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Beanstream.PaymentMethodDescription", "Betal med kreditkort.");
