...
namespace Nop.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        //Akiko
        IList<CustomPicture> GetProductPicturesByParentSku(string sku, int countryId, int pictureSize);

        CustomPicture GetProductPictureBySku(string sku, int countryId, int pictureSize);
    }
}
