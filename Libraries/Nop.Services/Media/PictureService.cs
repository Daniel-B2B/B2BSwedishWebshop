...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public IList<CustomPicture> GetProductPicturesByParentSku(string sku, int countryId, int pictureSize)
        {
            return _dbContext.SqlQuery<CustomPicture>("select * from [dbo].[ProductPicturesByParentSKU](" + countryId + ",'" + sku + "'," + pictureSize + ")").ToList();

        }

        public CustomPicture GetProductPictureBySku(string sku, int countryId, int pictureSize)
        {
            return _dbContext.SqlQuery<CustomPicture>("select * from [dbo].[ProductPicturesBySKU](" + countryId + ",'" + sku + "'," + pictureSize + ")").FirstOrDefault();
