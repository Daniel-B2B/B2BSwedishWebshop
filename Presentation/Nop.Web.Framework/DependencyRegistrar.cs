...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CustomPriceClassService>().As<ICustomPriceClassService>().InstancePerLifetimeScope();
            builder.RegisterType<HandlingPriceClassService>().As<IHandlingPriceClassService>().InstancePerLifetimeScope();
