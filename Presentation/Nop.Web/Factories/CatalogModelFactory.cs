    ...
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command)
        {
            ...
            var model = new CategoryModel
            {
                ...
                DescriptionBottom = category.GetLocalized(x => x.DescriptionBottom),
            ...
            #region Akiko Custom Code
            //Akiko Custom Code - Category Picture
            var categoryPictureCacheKey1 = string.Format(ModelCacheEventConsumer.CATEGORY_PICTURE_MODEL_KEY, category.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
            model.PictureModel = _cacheManager.Get(categoryPictureCacheKey1, () =>
            {
