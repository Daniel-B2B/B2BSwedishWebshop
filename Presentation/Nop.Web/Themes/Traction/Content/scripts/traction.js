(function () {
    ...
    $(document).ready(function () {
		...
		$(".home .responsive-nav-wrapper .search-wrap span").click(function(){
		  $('.slider-search-wrapper').show();
		});
		$(".overlayOffCanvas").click(function(){
		  $('.slider-search-wrapper').hide();
		});
		
		$(".homepage-popup .p-close").click(function() {
	...
	$(document).ready(function () {
		...
		$(document).on("click", ".flyout-cart-hide .flyout-hide", function(){
		  $('.flyout-cart').toggleClass('active');
		});
	});
