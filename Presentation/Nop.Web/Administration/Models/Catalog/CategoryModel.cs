...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class CategoryModel : BaseNopEntityModel, ILocalizedModel<CategoryLocalizedModel>
    {
        ...
        //akiko
        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.ProductSku")]
        public string ProductSku { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.CustomText")]
        public string CustomText { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.DescriptionBottom")]
        [AllowHtml]
